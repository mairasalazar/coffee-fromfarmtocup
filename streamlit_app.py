...
st.image("images/Coffee vs Tea Consumption.png")
components.html(
...
st.image("images/GDP per capita.png")
components.html(
...
st.image("images/Average Price ($) of a Cup of Coffee in thr World.png")
components.html(
...
st.image("images/Coffee Prod. Evolution.png")
components.html(
...
st.image("images/Dashboard 1.png")
components.html(
...
st.image("images/Comparison (2).png")
components.html(
...
st.image("images/Factchecker.png")
components.html(
...
st.image("images/WeightGain.png")
components.html(
...
st.image("images/Consumption_Happiness Correlation.png")
components.html(
...
st.image("images/Coffee Consumption - Heart Disease Deaths Relationship (Smoking Filter).png")
components.html(
