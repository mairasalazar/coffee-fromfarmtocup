...
st.write("""Hello, this is group 10’s visualization project, Coffee Journey: From the farm to your cup. In this project we will give insights into interesting facts that will raise awareness about economic factors of the coffee industry, as well as discuss certain preconceptions about coffee and lifestyle from a multinational perspective.""") 
...
st.write("""Our 2021 coffee map reveals a global coffee price rollercoaster! South Korea's cup averaged a whopping $7.71, while Albania offered the cheapest at $1.17. This geographic price gap highlights how economics and culture brew different coffee experience worldwide. """)
components.html(
